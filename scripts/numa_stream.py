...
__license__   = 'MIT'
__version__   = '1.0'
__copyright__ = 'Copyright 2018, The wrappi project'
...
if __name__ == '__main__':
    ...
    parser.add_option('-n', dest='size'   , default='80000000', help='stream array size')
    parser.add_option('-t', dest='rounds' , default='100', help='number of rounds')
    ...
    if param.cxx == 'intel':
        with open('Makefile','w') as f:
            f.write('CC=icc\n')
            f.write('CFLAGS= -O3 -xCORE-AVX2 -qopenmp -lnuma -DSTREAM_ARRAY_SIZE='+param.size)
            f.write(' -DNTIMES='+param.rounds+' -ffreestanding ')
